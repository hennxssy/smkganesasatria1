...
<body>
 ...
 <h3>Registrasi Form</h3>
  <form action="{{route('biodata.store')}}" method="POST">
		...
		<div class="wthree_fl">
		<div class="w3ls-name">	
                <input id="nisn" type="text" class="form-control" name="nisn" readonly value="{{ Auth::user()->biodata->nisn }}">
		</div>
		</div>
	</div>
		...
		<div class="w3ls-name">
			...
			<input type="text" name="nm_depan"  placeholder="first name" required=" "/>
		</div>
		<div class="w3ls-name">
			<input type="text" name="nm_belakang" placeholder="last name" required=""/>
		</div>
		</div>
	</div>
	...
	<div class="w3l_nm">
		...
		<div class="wthree_fl">
		<div class="w3ls-name">	
			<input type="text" name="tempat_lahir"  placeholder="Birth Place" required=" "/>
		</div>
		</div>
	</div>
...
<input class="date agileits w3layouts" name="tgl_lahir" id="datepicker2" type="text" placeholder="DD/MM/YY" required="">
		</div>
		</div>
		</div>
	</div>
	...
	<div class="w3l_nm">
		...
		<div class="wthree_fl">
		<div class="w3ls-name">	
			<input type="text" name="agama"  placeholder="Religion" required=" "/>
		</div>
		</div>
	</div>
	...
	<div class="w3l_nm">
		...
		<div class="wthree_fl">
		<div class="w3ls-name">	
			<input type="text" name="nm_ortu"  placeholder="Parent's Name" required=" "/>
		</div>
		</div>
	</div>
	...
	<div class="w3ls_ad">
		...
		<div class="w3_sd3">
			<input type="text" name="kota" placeholder="City" required=""/>
			</div>
			<div class="w3_sd4">
			<input type="text" name="provinsi" placeholder="Province" required=""/>
			</div>
		</div>
		<div class="w3ls-name1">
		<div class="w3_sd3">
			<input type="text" name="kode_pos" placeholder="Zip Code" required=""/>
			</div>
		<div class="w3_sd4">
			<select type="text" name="negara">
								<option name="negara" value="Country" disabled selected> Country </option>
	...
	<div class="w3l_nm">
		...
		<div class="wthree_fl">
		<div class="w3ls-name">	
			<input type="text" name="hp_siswa"  placeholder="No Handphone" required=" "/>
		</div>
		</div>
	</div>
	...
	<div class="w3l_nm">
		...
		<div class="wthree_fl">
		<div class="w3ls-name">	
			<input type="text" name="asal_sekolah"  placeholder="Origin School" required=" "/>
		</div>
		</div>
	</div>
